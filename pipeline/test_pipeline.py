...
df = pd.DataFrame({'model_2a':y_pred_2a, 'model_2b':y_pred_2b,'ground_truth':df_test['class'].values.tolist(), 'confidence_2a':y_pred_2a_confidence, 'confidence_2b':y_pred_2b_confidence})
# final prediction 
